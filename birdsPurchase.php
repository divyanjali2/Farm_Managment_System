                    ...
                    <tbody>
                        ...
                        foreach ($myrow as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="edit_btn"
                                        href="birdsPurchase.php?birdspurchupdate=1&id=<?php echo $row["BirdsPurchase_ID"]; ?>">Edit</a>
                                </td>
                                <td>
                                    <a class="del_btn"
                                        href="includes/action.php?birdspurchdelete=1&id=<?php echo $row["BirdsPurchase_ID"]; ?>">Delete</a>
                                </td>
                            </tr>
                            <?php
                        }
                ...
                if (isset ($_GET["birdspurchupdate"])) {
                    ...
                    <form action="includes/action.php" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <input id="Date" type="date" name="Date" value="<?php echo $row["Date"]; ?>" required>
                        </div>
                        <div class="input-group">
                            <label for="">Number of Birds</label>
                            <input type="number" step="any" name="NumberOfBirds"
                                value="<?php echo $row["NumberOfBirds"]; ?>" required>
                        </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            <button type="submit" name="birdspurchase" class="btn" value="">Update</button>
                        </div>
                    </form>
                    <?php
                } else {
                    ...
                    <form action="includes/action.php" method="post">
                        ...
                        <div class="input-group">
                            <button type="submit" name="birdspurchase" class="btn">Save</button>
                        </div>
                    </form>
                    <?php
                }
